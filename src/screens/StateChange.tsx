...
const StateChange: React.SFC<StateChangeProps> = (props:any) => {
    ...
    return ( 
        <View>
            <View style={{width:'100%',height:'50%',justifyContent:'center',alignItems:'center',backgroundColor:props.backgroundColor}}>
                <TouchableWithoutFeedback onPress={()=>navigation.navigate('Unmounted')}>
                <Text>Go To Unmounted Screen</Text>
                </TouchableWithoutFeedback>
            </View>
            <TouchableWithoutFeedback
            onPress={props.changeBackgroundColor}
            >
            <View style={{width:'100%',height:'50%',justifyContent:'center',alignItems:'center',backgroundColor:props.backgroundColor}}
            >
